			...
			<div class="row">
				...
				<div class = "login-section">
					<form method = "post" action="addproduct">
						<strong>Name:</strong> <input class = "login-section-content" pattern="[0-9A-Za-z.,'-_\s]{0,100}" type = "text" name = "productName"required/><br>
						...
						<strong>Description:</strong> <input class = "login-section-content" pattern="[0-9A-Za-zñ._,-\s]{1,50}" type = "text" name = "productDescription"required/><br>
